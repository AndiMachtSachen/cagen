...
bool t_15 = DOWN && contract_trans_DOWN_DOWN_3;
bool t_16 = DOWN && contract_trans_DOWN_DOWN_4;
bool t_18 = uP && contract_trans_uP_DOWN_5;
bool t_19 = DOWN && contract_trans_DOWN_uP_6;
...
bool VALID_POST_COND = (uP && t_12) || (uP && t_13) || (DOWN && t_15) || (DOWN && t_16) || (uP && t_18) || (DOWN && t_19);
uP = t_12 || t_13 || t_19;
DOWN = t_15 || t_16 || t_18;
